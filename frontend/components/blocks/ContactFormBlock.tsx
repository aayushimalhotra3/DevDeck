...
const ContactFormBlock: React.FC<ContactFormBlockProps> = ({
  ...
  const renderFormField = (field: FormField) => {
    ...
    return (
      <div
        key={field.id}
        className={`space-y-2 ${isDisabled ? 'opacity-50' : ''}`}
      >
        ...
        <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Receive emails when someone submits the form
                      </p>
                    </div>
                    <Switch
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Send automatic confirmation to submitters
                      </p>
                    </div>
                    <Switch
                  ...
                  {settings.autoReply && (
                    <div>
                      ...
                      <Textarea
                        ...
                        onChange={e =>
                          updateSettings({ autoReplyMessage: e.target.value })
                        }
          ...
          {!isEditing &&
            Object.keys(contactInfo).some(
              key => contactInfo[key as keyof ContactInfo]
            ) && (
          ...
          <div className="flex items-start gap-2 p-3 bg-blue-50 rounded-lg">
            ...
            <div className="text-sm text-blue-800">
              ...
              <p className="text-blue-700">
                ...
                respond to your inquiry. We respect your privacy and will never
